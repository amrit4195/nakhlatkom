...
// query products
$stmt = $user_data->sign_up_check_phone($input_phone);
$num = $stmt->rowCount();
...
if($num>0){
  ...
  $stmt = $user_data->sign_up_create_account($input_username, $input_password, $input_phone);
  $num = $stmt->rowCount();
  echo json_encode(
      array("message" => "Create new")
  );
}
